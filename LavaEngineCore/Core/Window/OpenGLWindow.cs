...
namespace LavaEngine.Core.Window.OpenGLWindow;
...
public class OpenGLWindow
{
    ...
    public int CreateWindow(ScriptManager manager,
        ...
        string title = "LavaEngine OpenGL Window",
        bool VSync = true)
    {
    ...
    private void OnLoad()
    {
        ...
        _window.Resize += (size) =>
        {
            _mouseSystem.WindowSize = new Vector2(size.X, size.Y);
        };

        _logger.Trace("OpenGL window loaded, calling all Start functions...");
